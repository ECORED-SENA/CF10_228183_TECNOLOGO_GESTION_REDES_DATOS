  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Verificando dispositivos de cómputo y servicios de red
        p.mb-4 Reforzar los conceptos, acciones y procedimientos de la verificación de dispositivos y servicios de red, con base en los temas desarrollados en el componente formativo.
